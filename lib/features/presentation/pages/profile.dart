...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          children: [
            SizedBox(height: MediaQuery.of(context).size.width * 0.45,width: double.infinity,
                child: Image.asset("assets/pro1.png", alignment: Alignment.center,fit: BoxFit.fill,)
            ),
            ...
            SingleChildScrollView(
                ...
                children: [
                  Align(alignment: Alignment.topCenter,
                    child: Padding(
                      ...
                      child: Container(
                        child: Image.asset("assets/pro2.png", alignment: Alignment.center,fit: BoxFit.fill,),
                        height: 100,
                        width: 100,
              ...
              const Text('Fashion World', textAlign: TextAlign.left, style: TextStyle(
  ...
  Widget _rowTexts(){
    return Row(
      children:  [
        Expanded(child: Container()),
        const Text("981", style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal)),
        const Padding(
          padding: EdgeInsets.all(8.0),
          child: Text("posts", style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal)),
        ),
        const Text("83.8k", style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal)),
        const Padding(
          padding: EdgeInsets.all(8.0),
          child: Text("followers", style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal)),
        ),
        Expanded(child: Container()),
      ],
    );
              ...
              child: Stack(
                  children: const <Widget>[
                    Positioned(
                        top: 12,
                        left: 16,
                        child: Text('Subscribe', textAlign: TextAlign.left, style: TextStyle(
                            color: Color.fromRGBO(255, 255, 255, 1),
                            fontFamily: 'Inter',
                            fontSize: 14,
                            letterSpacing: 0,
